<script>
	...
	import { variables, selectedVariable, regions, selectedRegion } from '$lib/stores/selectStore.js';
...
<!-- <header -->
<!-- 	class="fixed md:hidden top-0 z-40 flex-none h-20 w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-gray-800" -->
<!-- > -->
<header
...
>
	...
	>
		...
		<NavBrand href="/">
			<span class="self-center whitespace-nowrap text-xl font-bold"> FWI indices in UK</span>
		</NavBrand>
